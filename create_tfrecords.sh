...
[ -d /home/maggie2/tfrecords ] || mkdir /home/maggie2/tfrecords
...
#out=/home/maggie/tfrecords/
csv=/home/maggie2/csv_files/
out=/home/maggie2/tfrecords/
...
for file in "$csv"*.csv; do
	...
	python3 /home/maggie2/bert/create_pretraining_data.py --input_file="$file" --output_file="$out$filename".tfrecord --vocab_file=$BERT_BASE_DIR/vocab.txt --do_lower_case=False --max_seq_length=128 --max_predictions_per_seq=20 --masked_lm_prob=0.15 --random_seed=12345 --dupe_factor=5
done
